...
#define FORELGTBLK "\x1B[90m"  // Light Black
#define FORELGTRED "\x1B[91m"  // Light Red
#define FORELGTGRN "\x1B[92m"  // Light Green
#define FORELGTYEL "\x1B[93m"  // Light Yellow
#define FORELGTBLU "\x1B[94m"  // Light Blue
#define FORELGTMAG "\x1B[95m"  // Light Magenta
#define FORELGTCYN "\x1B[96m"  // Light Cyan
#define FORELGTWHT "\x1B[97m"  // Light White
...
#define LGTBLK(x) FORELGTBLK x RESETTEXT
#define LGTRED(x) FORELGTRED x RESETTEXT
#define LGTGRN(x) FORELGTGRN x RESETTEXT
#define LGTYEL(x) FORELGTYEL x RESETTEXT
#define LGTBLU(x) FORELGTBLU x RESETTEXT
#define LGTMAG(x) FORELGTMAG x RESETTEXT
#define LGTCYN(x) FORELGTCYN x RESETTEXT
#define LGTWHT(x) FORELGTWHT x RESETTEXT
